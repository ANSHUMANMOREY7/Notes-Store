  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-blue-900 relative overflow-x-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute w-1 h-1 bg-white rounded-full animate-pulse" style={{ top: "20%", left: "70%" }} />
        <div className="absolute w-1 h-1 bg-white rounded-full animate-pulse" style={{ top: "40%", left: "40%" }} />
        <div className="absolute w-1.5 h-1.5 bg-white rounded-full animate-pulse" style={{ top: "30%", left: "15%" }} />
        <div className="absolute w-2 h-2 bg-purple-300 rounded-full animate-pulse" style={{ top: "60%", left: "80%" }} />
      </div>
