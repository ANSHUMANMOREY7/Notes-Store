...
const HomeHeroText = () => {
  return (
    <>
    <div className=''>
      <h2 className='font-[Font1]  font-bold text-center text-[170px] p-3 text-white  tracking-tighter uppercase drop-shadow-2xl leading-[10vw] mt-50 ' style={{ fontSize: 'min(170px, 10vw)' }}>NOTES STORE</h2>
